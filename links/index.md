          ...
          <div class="panel-group">
            <div class="panel panel-default">
              ...
              <div id="intro" class="panel-collapse collapse">
                <ul class="list-group">
                  <li class="list-group-item"><a href="https://stat.ethz.ch/R-manual/R-devel/doc/manual/R-intro.html"></a></li>
                  <li class="list-group-item"><a href="http://tryr.codeschool.com"></a></li>
                  <li class="list-group-item"><a href="https://www.datacamp.com/courses/free-introduction-to-r"></a></li>
                </ul>
              </div>
            </div>
          </div>
